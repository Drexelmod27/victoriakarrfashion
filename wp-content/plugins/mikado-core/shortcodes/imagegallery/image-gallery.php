...
class ImageGallery implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('Image Gallery', 'mkd_core'),
            'base'                      => $this->getBase(),
            ...
            'params'                    => array(
                ...
                array(
                    ...
                    'description' => esc_html__('Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "thumbnail" size', 'mkd_core')
                ),
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Gallery Type', 'mkd_core'),
                    'admin_label' => true,
                    'param_name'  => 'type',
                    'value'       => array(
                        esc_html__('Slider', 'mkd_core')     => 'slider',
                        esc_html__('Image Grid', 'mkd_core') => 'image_grid'
                    ),
                    'description' => esc_html__('Select gallery type', 'mkd_core'),
                    'save_always' => true
                ),
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Slide duration', 'mkd_core'),
                    'admin_label' => true,
                    'param_name'  => 'autoplay',
                    'value'       => array(
                        '3'                          => '3',
                    ...
                    'description' => esc_html__('Auto rotate slides each X seconds', 'mkd_core'),
                ),
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Slide Animation', 'mkd_core'),
                    'admin_label' => true,
                    'param_name'  => 'slide_animation',
                    'value'       => array(
                        esc_html__('Slide', 'mkd_core')      => 'slide',
                        esc_html__('Fade', 'mkd_core')       => 'fade',
                        esc_html__('Fade Up', 'mkd_core')    => 'fadeUp',
                        esc_html__('Back Slide', 'mkd_core') => 'backSlide',
                        esc_html__('Go Down', 'mkd_core')    => 'goDown'
                    ),
                    'save_always' => true,
                    'dependency'  => array(
                        'element' => 'type',
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Column Number', 'mkd_core'),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Spacing', 'mkd_core'),
                    'param_name'  => 'spacing',
                    'value'       => array(
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Open PrettyPhoto on click', 'mkd_core'),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Grayscale Images', 'mkd_core'),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Show Navigation Arrows', 'mkd_core'),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Arrows Skin', 'mkd_core'),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Show Pagination', 'mkd_core'),
