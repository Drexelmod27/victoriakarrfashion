...
class AnimationsHolder implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(
            array(
                'name'                    => esc_html__('Animations Holder', 'mkd_core'),
                'base'                    => $this->base,
                ...
                'params'                  => array(
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Animation', 'mkd_core'),
                        'param_name'  => 'css_animation',
                        'value'       => array(
                            esc_html__('No animation', 'mkd_core')                    => '',
                            esc_html__('Elements Shows From Left Side', 'mkd_core')   => 'mkd-element-from-left',
                            esc_html__('Elements Shows From Right Side', 'mkd_core')  => 'mkd-element-from-right',
                            esc_html__('Elements Shows From Top Side', 'mkd_core')    => 'mkd-element-from-top',
                            esc_html__('Elements Shows From Bottom Side', 'mkd_core') => 'mkd-element-from-bottom',
                            esc_html__('Elements Shows From Fade', 'mkd_core')        => 'mkd-element-from-fade'
                        ),
                        'save_always' => true,
                        'admin_label' => true,
                        'description' => ''
                    ...
                    array(
                        'type'        => 'textfield',
                        'class'       => '',
                        'heading'     => esc_html__('Animation Speed (ms)', 'mkd_core'),
