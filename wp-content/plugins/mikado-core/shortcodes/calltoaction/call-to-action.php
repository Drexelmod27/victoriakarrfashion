...
class CallToAction implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        foreach($call_to_action_button_IconCollections as $collection_key => $collection) {
            ...
            $call_to_action_button_icons_array[] = array(
                'type'        => 'dropdown',
                'heading'     => esc_html__('Button Icon', 'mkd_core'),
        ...
        vc_map(array(
            'name' => esc_html__( 'Call to Action', 'mkd_core' ),
            'base'                      => $this->getBase(),
            ...
            'params'                    => array_merge(
                array(
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Full Width', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Content in grid', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Grid size', 'mkd_core'),
                    ...
                    array(
                        ...
                        'value'       => array(
                            ...
                            esc_html__('With Icon', 'mkd_core') => 'with-icon',
                        ),
                        'save_always' => true,
                        'description' => ''
                    )
                ...
                array(
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Box Padding (top right bottom left) px', 'mkd_core'),
                        'param_name'  => 'box_padding',
                        'admin_label' => true,
                        'description' => esc_html__('Default padding is 20px on all sides', 'mkd_core'),
                        'group'       => esc_html__('Advanced Options', 'mkd_core'),
                    ),
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Button Color', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Button Hover Color', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Button Hover Background Color', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Box Background Color', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Box Border Color', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Box Border Width (px)', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Default Text Font Size (px)', 'mkd_core'),
                        'param_name'  => 'text_size',
                        'description' => esc_html__('Font size for p tag', 'mkd_core'),
                        'group'       => esc_html__('Advanced Options', 'mkd_core'),
                    ),
                    array(
                        'type'        => 'dropdown',
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Type', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Hover Button Type', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Hover Animation', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Position', 'mkd_core'),
                        'param_name'  => 'button_position',
                        'value'       => array(
                            esc_html__('Default/right', 'mkd_core') => '',
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Size', 'mkd_core'),
                        ...
                        'value'       => array(
                            ...
                            esc_html__('Extra Large', 'mkd_core') => 'big_large'
                        ),
                        'description' => '',
                        'dependency'  => array('element' => 'show_button', 'value' => array('yes')),
                        'group'       => esc_html__('Advanced Options', 'mkd_core'),
                    ...
                    array(
                        ...
                        'admin_label' => true,
                        'description' => esc_html__('Default text is "button"', 'mkd_core'),
                        'dependency'  => array('element' => 'show_button', 'value' => array('yes'))
                    ),
                    array(
                        'type'        => 'textfield',
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Icon Pack', 'mkd_core'),
