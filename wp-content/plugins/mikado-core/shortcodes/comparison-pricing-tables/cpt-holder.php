...
class ComparisonPricingTablesHolder implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                    => esc_html__('Comparison Pricing Tables', 'mkd_core'),
            'base'                    => $this->base,
            ...
            'params'                  => array(
                ...
                array(
                    ...
                    'holder'      => 'div',
                    'class'       => '',
                    'heading'     => esc_html__('Features', 'mkd_core'),
                    'param_name'  => 'features',
                    'value'       => '',
                    'save_always' => true,
                    'description' => esc_html__('Enter features. Separate each features with new line (enter).', 'mkd_core')
                ),
                array(
                    'type'        => 'colorpicker',
                    'holder'      => 'div',
