...
class UnorderedList implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('List - Unordered', 'mkd_core'),
            'base'                      => $this->base,
            ...
            'params'                    => array(
                ...
                array(
                    'type'        => 'dropdown',
                    'admin_label' => true,
                    'heading'     => esc_html__('Animate List', 'mkd_core'),
                    'param_name'  => 'animate',
                    'value'       => array(
                ...
                array(
                    ...
                    'value'       => array(
                        ...
                        esc_html__('Bold', 'mkd_core')    => 'bold'
                    ),
                    'description' => ''
                ),
                array(
                    'type'       => 'textfield',
                    'heading'    => esc_html__('Padding left (px)', 'mkd_core'),
