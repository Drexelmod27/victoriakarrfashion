...
class Workflow implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                    => esc_html__('Workflow', 'mkd_core'),
            'base'                    => $this->base,
            ...
            'params'                  => array(
                ...
                array(
                    'type'        => 'colorpicker',
                    'heading'     => esc_html__('Workflow line color', 'mkd_core'),
                    'param_name'  => 'line_color',
                    'description' => esc_html__('Pick a color for the workflow line.', 'mkd_core')
                ),
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Animate Workflow', 'mkd_core'),
                    'param_name'  => 'animate',
                    'value'       => array(
                        esc_html__('Yes', 'mkd_core') => 'yes',
                        esc_html__('No', 'mkd_core')  => 'no',
                    ),
                    'description' => esc_html__('Animate Workflow shortcode when it comes into viewport', 'mkd_core'),
                    'save_always' => true,
                )
            )
        ));
