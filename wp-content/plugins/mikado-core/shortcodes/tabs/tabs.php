        ...
        vc_map(array(
            ...
            'params'                  => array(
                array(
                    ...
                    'param_name'  => 'style',
                    'value'       => array(
                        esc_html__('Horizontal With Text', 'mkd_core')           => 'horizontal_with_text',
                        esc_html__('Horizontal With Icons', 'mkd_core')          => 'horizontal_with_icons',
                        esc_html__('Horizontal With Text And Icons', 'mkd_core') => 'horizontal_with_text_and_icons',
                        esc_html__('Vertical With Text', 'mkd_core')             => 'vertical_with_text',
                        esc_html__('Vertical With Icons', 'mkd_core')            => 'vertical_with_icons',
                        esc_html__('Vertical With Text and Icons', 'mkd_core')   => 'vertical_with_text_and_icons'
                    ),
                    'save_always' => true,
                    'description' => ''
                ),
                array(
                    'heading'     => esc_html__('Navigation Width', 'mkd_core'),
                    'type'        => 'dropdown',
                    'admin-label' => true,
                    'param_name'  => 'navigation_width',
                    'value'       => array(
                        esc_html__('Medium', 'mkd_core') => '',
