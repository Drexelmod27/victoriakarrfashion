...
class GoogleMap implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(
            array(
                'name'                    => esc_html__('Google Map', 'mkd_core'),
                'base'                    => $this->base,
                ...
                'params'                  => array(
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 1', 'mkd_core'),
                        'param_name'  => 'address1',
                        'admin_label' => true
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 2', 'mkd_core'),
                        'param_name'  => 'address2',
                        'admin_label' => true,
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 3', 'mkd_core'),
                        'param_name'  => 'address3',
                        'admin_label' => true,
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 4', 'mkd_core'),
                        'param_name'  => 'address4',
                        'admin_label' => true,
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 5', 'mkd_core'),
                        'param_name'  => 'address5',
                        'admin_label' => true,
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Custom Map Style', 'mkd_core'),
                        ...
                        'save_always' => true,
                        'description' => esc_html__('Enabling this option will allow Map editing', 'mkd_core')
                    ),
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Frame', 'mkd_core'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Color Overlay', 'mkd_core'),
                        'param_name'  => 'color_overlay',
                        'description' => esc_html__('Choose a Map color overlay', 'mkd_core'),
                        'dependency'  => Array('element' => 'custom_map_style', 'value' => array('true'))
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Saturation', 'mkd_core'),
                        'param_name'  => 'saturation',
                        'description' => esc_html__('Choose a level of saturation (-100 = least saturated, 100 = most saturated)', 'mkd_core'),
                        'dependency'  => Array('element' => 'custom_map_style', 'value' => array('true'))
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Lightness', 'mkd_core'),
                        'param_name'  => 'lightness',
                        'description' => esc_html__('Choose a level of lightness (-100 = darkest, 100 = lightest)', 'mkd_core'),
                        'dependency'  => Array('element' => 'custom_map_style', 'value' => array('true'))
                    ),
                    array(
                        'type'        => 'attach_image',
                        'heading'     => esc_html__('Pin', 'mkd_core'),
                        'param_name'  => 'pin',
                        'description' => esc_html__('Select a pin image to be used on Google Map', 'mkd_core')
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Map Zoom', 'mkd_core'),
                        'param_name'  => 'zoom',
                        'description' => esc_html__('Enter a zoom factor for Google Map (0 = whole worlds, 19 = individual buildings)', 'mkd_core')
                    ),
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Zoom Map on Mouse Wheel', 'mkd_core'),
                        ...
                        'save_always' => true,
                        'description' => esc_html__('Enabling this option will allow users to zoom in on Map using mouse wheel', 'mkd_core')
                    ),
                    array(
                        'type'       => 'textfield',
                        'heading'    => esc_html__('Map Height', 'mkd_core'),
