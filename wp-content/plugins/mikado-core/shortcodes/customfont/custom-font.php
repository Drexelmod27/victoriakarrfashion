...
class CustomFont implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('Custom Font', 'mkd_core'),
            'base'                      => $this->getBase(),
            ...
            'params'                    => array(
                array(
                    "type"       => "dropdown",
                    "heading"    => esc_html__("Custom Font Tag", 'mkd_core'),
                ...
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Font family", 'mkd_core'),
                ...
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Line height (px)", 'mkd_core'),
                    "param_name" => "line_height",
                    "value"      => ""
                ),
                array(
                    "type"        => "dropdown",
                    "heading"     => esc_html__("Font Style", 'mkd_core'),
                ...
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Letter Spacing (px)", 'mkd_core'),
                ...
                array(
                    "type"        => "dropdown",
                    "heading"     => esc_html__("Text decoration", 'mkd_core'),
                    "param_name"  => "text_decoration",
                    "value"       => array(
                        esc_html__('None', 'mkd_core')         => '',
                        esc_html__('Underline', 'mkd_core')    => 'underline',
                        esc_html__('Overline', 'mkd_core')     => 'overline',
                        esc_html__('Line Through', 'mkd_core') => 'line-through'
                    ),
                    "description" => ""
                ),
                array(
                ...
                array(
                    ...
                    "value"       => array(
                        ...
                        esc_html__('Justify', 'mkd_core') => 'justify'
                    ),
                    "description" => ""
                ),
                array(
                    ...
                    "value"       => esc_html__('Custom Font Content', 'mkd_core'),
                    "description" => "",
                    "save_always" => true
                )
            )
