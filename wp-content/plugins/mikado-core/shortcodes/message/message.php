...
class Message implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Message', 'mkd_core'),
			'base'                      => $this->base,
			...
			'params'                    => array_merge(
				array(
					array(
						...
						'value'       => array(
							...
							esc_html__('With Icon', 'mkd_core') => 'with_icon'
						),
						'save_always' => true
					)
				),
				...
				array(
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Border Width (px)', 'mkd_core'),
						'param_name'  => 'border_width',
						'description' => esc_html__('Default value is 0', 'mkd_core')
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Color', 'mkd_core'),
