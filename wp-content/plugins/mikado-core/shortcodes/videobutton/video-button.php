...
class VideoButton implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('Video Button', 'mkd_core'),
            'base'                      => $this->getBase(),
            ...
            'params'                    => array(
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__('Video Link', 'mkd_core'),
                    "param_name" => "video_link",
                    "value"      => ""
                ),
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__('Play Button Size (px)', 'mkd_core'),
                ...
                array(
                    'type'        => 'dropdown',
                    'admin_label' => true,
                    'heading'     => esc_html__('Video Button Style', 'mkd_core'),
